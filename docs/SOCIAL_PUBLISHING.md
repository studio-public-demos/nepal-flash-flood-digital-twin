...
- Do not add casualty counts, missing-person counts, damage totals or operational response claims without a same-day source review.
- The public build can describe terrain-constrained replay, scenario comparison, downstream exposure and provenance.
- The public build should not imply official forecast, official warning, confirmed damage, calibrated hydraulic modeling or redistributed satellite imagery pixels.
